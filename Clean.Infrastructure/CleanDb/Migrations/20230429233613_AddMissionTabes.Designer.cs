...
namespace Clean.Infrastructure.CleanDb.Migrations
{
    ...
    [Migration("20230429233613_AddMissionTabes")]
    partial class AddMissionTabes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.Employee", b =>
                {
                    ...
                    b.HasIndex("ActiveCardId")
                        .IsUnique()
                        .HasFilter("[ActiveCardId] IS NOT NULL");
            ...
            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.Mission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.MissionDestination", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MissionDestinations", (string)null);
                });

            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.MissionParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.Mission", b =>
                {
                    b.HasOne("Clean.Infrastructure.CleanDb.Models.User", null)
                        .WithMany()
                    ...
                    b.HasOne("Clean.Infrastructure.CleanDb.Models.Status", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Clean.Infrastructure.CleanDb.Models.MissionDestination", b =>
                {
                    ...
                    b.HasOne("Clean.Infrastructure.CleanDb.Models.Mission", null)
                        .WithMany()
